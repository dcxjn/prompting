...
def main():
    ...
    def get_image_description(info_dict: dict) -> dict:
        ...
        cogvlm_history.append((query, response))
    ...
    def get_instructions(info_dict: dict) -> dict:
        ...
        The image depicts a scenario in which the robot is supposed to complete a task in.
        Given the task of: {info_dict["task"]}, what are some information essential to completing the task?
        Generate all necessary questions to obtain the desired information.
